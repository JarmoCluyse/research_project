...
class Adc:
    def __init__(self):
        logging.info("Adc was instanciated")
        # Get I2C bus
    ...
    def analogReadPCF8591(self,chn):
        #PCF8591 read ADC value,chn:0,1,2,3
...
if __name__ == '__main__':
    ...
    logging.info("Program AdcModule started")
    try:
        loop()
    except KeyboardInterrupt: 
        destroy()
    finally:
        logging.info("Program AdcModule ended")
